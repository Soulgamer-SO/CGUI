...
bool cg_create_command_buffer_array(cg_var_t *p_var, VkCommandPool command_pool, VkCommandBuffer *command_buffer_array, uint32_t command_buffer_count) {
	...
	p_var->library_var.vk_result = allocate_command_buffers(p_var->logic_device_var.vk_logic_device, &command_buffer_allocate_info, command_buffer_array);
	if (p_var->library_var.vk_result != VK_SUCCESS) {
...
bool cg_begin_record_command_buffer(cg_var_t *p_var, VkCommandBuffer command_buffer, VkCommandBufferUsageFlags command_buffer_usage) {
...
bool cg_end_record_command_buffer(cg_var_t *p_var, VkCommandBuffer command_buffer) {
...
bool cg_reset_command_buffer(cg_var_t *p_var, VkCommandBuffer command_buffer, VkCommandBufferResetFlags command_buffer_reset_flag) {
...
bool cg_reset_command_pool(cg_var_t *p_var, VkCommandPool command_pool, VkCommandBufferResetFlags command_buffer_reset_flag) {
